...
class ShoppingCart:
    ...
    def remove_item(self, item_name):
        ...
        if item is None:
            print("Item not found in cart. Please enter correct item..")
        else:
    ...
    def modify_item(self, item_name):
        ...
        if item is None:
            ...
            item.item_quantity =  myvalidator.validate_int("Enter updated Item Quantity:","Invalid input.Please enter Item Quantity in numbers:")
